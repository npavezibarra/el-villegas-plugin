...
<body style="font-family: Arial, sans-serif; background-color: white; margin: 0; padding: 0;">
  ...
  <!-- Encabezado con Logo -->
  <div style="text-align:center; max-width:600px; padding:20px 40px; margin:0px auto 0px auto; border:1px solid #dbdbdb; border-radius:8px 8px 0px 0px; background:white;">
  ...
  <!-- Contenido principal -->
  <div style="max-width:600px; margin:0 auto; background-color:#f4f4f4; padding:40px; border-radius:0px 0px 8px 8px; border:1px solid #dbdbdb;">

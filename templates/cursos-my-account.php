...
if ( empty( $user_courses ) ) {
    ...
    echo '<a href="' . esc_url( home_url( '/courses' ) ) . '" class="button ver-cursos" style="display: inline-block; font-size: 12px; padding: 10px 20px; background-color: #0073aa; color: #fff; text-decoration: none; border-radius: 5px;">VER CURSOS</a>';
    echo '</div>';
    return;
}

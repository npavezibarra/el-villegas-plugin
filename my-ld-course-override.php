...
// Encolar el archivo JavaScript para registro/login si es necesario
function my_custom_ld_scripts() {
    wp_enqueue_script('form-toggle-js', plugin_dir_url(__FILE__) . 'login-register/form-toggle.js', ['jquery'], '1.0', true);
}
add_action('wp_enqueue_scripts', 'my_custom_ld_scripts');

...
// Add a custom body class for the 'ingresa-roma' page
function add_ingresa_roma_body_class($classes) {
    if (is_page('ingresa-roma')) {
        $classes[] = 'ingresa-roma';
    }
    return $classes;
}
add_filter('body_class', 'add_ingresa_roma_body_class');
?>
